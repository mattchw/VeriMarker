...
//         let assignment1 = Assignment(id: 1, name: "Assignment 1", image: defaultImg, submittedNum: 18, dueDate: Convertor.stringToDate(dateString: "2016-11-15 23:59:59")!)!
//         let assignment2 = Assignment(id: 2, name: "Assignment 2", image: defaultImg, submittedNum: 18, dueDate: Convertor.stringToDate(dateString: "2016-11-15 23:59:59")!)!
//         let assignment3 = Assignment(id: 3, name: "Assignment 3", image: defaultImg, submittedNum: 18, dueDate: Convertor.stringToDate(dateString: "2016-11-15 23:59:59")!)!
//         let assignment4 = Assignment(id: 4, name: "Assignment 4", image: defaultImg, submittedNum: 18, dueDate: Convertor.stringToDate(dateString: "2016-11-15 23:59:59")!)!
//         assignments += [assignment1, assignment2, assignment3, assignment4]
        
        print("loadAssignment# start")
  ...
  func animateTable() {
    print("Trying to reload data now...")
...
//    print(assignments)
  ...
  func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    ...
    cell.name.text = "Assignment " + String(describing: assignment.asgnNum)
    cell.assignmentImage.image = assignment.image
    cell.subTitle.text = "DUE "
    cell.submittedNumber.text = String(assignment.submitNum) + " / " + String(assignment.enrollNum)//assignment.totalNum
    cell.submittedProgress.setProgress(Float(assignment.submitNum) / Float(assignment.enrollNum), animated: true)
    cell.lastSubmissionDateTime.text = assignment.lastSubmitTime
    return cell
  }
